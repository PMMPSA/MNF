...
Class Boss extends PluginBase implements Listener
{
	...
	public function spawnBoss($id, $cast = false){
        ...
        //});
		if($cast){
			Server::getInstance()->broadcastMessage("§l§c【 BOSS §fINFO 】 §r§aQuái vật§e ".$ent->getNameTag()."§r§a đã được hồi sinh tại §e[/warp boss]§a, mau chóng tiêu diệt ngay để nhận quà.");
		}
